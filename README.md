...
1. Create a new repository on GitHub with the name `ioBroker.gotify`
...
1. Link your local repository with the one on GitHub:  
    ```bash
    git remote add origin https://github.com/ThomasPohl/ioBroker.gotify
    ```
...
1. Overwrite the changed files in the adapter directory (`/opt/iobroker/node_modules/iobroker.gotify`)
1. Execute `iobroker upload gotify` on the ioBroker host
